...
No. It's only for pages so shouldn't be used if you rely on 'read more' links to link to the full post when you're outputting excerpts, say on a homepage list of recent posts.
...
Yes: modify the_content function in your templates e.g. `<?php the_content('<p class="serif">Read the rest of this page &raquo;</p>'); ?>`
...
== Changelog ==
= 0.3 =
* Fixed javascript register/enqueue function
