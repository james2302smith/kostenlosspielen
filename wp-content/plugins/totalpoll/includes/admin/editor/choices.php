...
<div class="choices section <?php echo!isset($last_opened_tabs['choices']) ? 'collapsed' : '' ?>">
	...
	<?php do_tp_action('tp_admin_editor_before_choices_content', $options); ?>
        ...
        <ul class="choice-types">
            <li><button type="button" class="button" data-template="choice-text"><?php _e('Text', TP_TD); ?></button></li>
            <li><button type="button" class="button" data-template="choice-link"><?php _e('Link', TP_TD); ?></button></li>
            <li><button type="button" class="button" data-template="choice-image"><?php _e('Image', TP_TD); ?></button></li>
            <li><button type="button" class="button" data-template="choice-video"><?php _e('Video', TP_TD); ?></button></li>
            <li><button type="button" class="button" data-template="choice-html"><?php _e('HTML', TP_TD); ?></button></li>
		...
		<?php foreach ( $options->choices as $index => $choice ): ?>
		    ...
		    <?php elseif ( $choice->type == 'link' ): ?>
	    		...
	    		<input type="hidden" name="tp_options[choices][<?php echo $index; ?>][type]" value="link">
			<label class="horizontal-label votes-label"><?php _e('Votes', TP_TD); ?>:</label>
	    		<input type="text" placeholder="<?php _e('Votes', TP_TD); ?>" name="tp_options[choices][<?php echo $index; ?>][votes]" value="<?php echo esc_attr($choice->votes) ?>" class="votes-counter widefat">
			<label class="horizontal-label"><?php _e('URL', TP_TD); ?>:</label>
	    		<input type="text" placeholder="<?php _e('URL', TP_TD); ?>" name="tp_options[choices][<?php echo $index; ?>][url]" value="<?php echo esc_attr($choice->url) ?>" class="widefat">
			<label class="horizontal-label"><?php _e('Label', TP_TD); ?>:</label>
			    ...
			    <?php do_tp_action("tp_admin_editor_link_choice_fields", $choice, $index); ?>
	    		<input type="hidden" name="tp_options[choices][<?php echo $index; ?>][last_index]" value="<?php echo $index; ?>">
	    		<ul class="choice-controllers">
	    		    <li><button type="button" class="move">&equiv;</button></li>
	    		    <li><button type="button" class="delete">&#10006;</button></li>
		    ...
		    <?php elseif ( $choice->type == 'video' ): ?>
	    		...
	    		<input type="hidden" name="tp_options[choices][<?php echo $index; ?>][type]" value="video">
			<label class="horizontal-label votes-label"><?php _e('Votes', TP_TD); ?>:</label>
	    		<input type="text" placeholder="<?php _e('Votes', TP_TD); ?>" name="tp_options[choices][<?php echo $index; ?>][votes]" value="<?php echo esc_attr($choice->votes) ?>" class="votes-counter widefat">
			<label class="horizontal-label"><?php _e('Thumbnail', TP_TD); ?>:</label>
	    		<input type="text" placeholder="<?php _e('Thumbnail', TP_TD); ?>" name="tp_options[choices][<?php echo $index; ?>][image]" value="<?php echo esc_attr($choice->image) ?>" class="widefat upload-holder">
			<label class="horizontal-label"><?php _e('Embed', TP_TD); ?>:</label>
	    		<input type="text" placeholder="<?php _e('Video embed code', TP_TD); ?>" name="tp_options[choices][<?php echo $index; ?>][video]" value="<?php echo esc_attr($choice->video) ?>" class="widefat">
			<label class="horizontal-label"><?php _e('Label', TP_TD); ?>:</label>
	    		<input type="text" placeholder="<?php _e('Label', TP_TD); ?>" name="tp_options[choices][<?php echo $index; ?>][label]" value="<?php echo esc_attr($choice->label) ?>" class="widefat">
			    <?php do_tp_action("tp_admin_editor_video_choice_fields", $choice, $index); ?>
	    		<input type="hidden" name="tp_options[choices][<?php echo $index; ?>][last_index]" value="<?php echo $index; ?>">
	    		<ul class="choice-controllers">
	    		    <li><button type="button" class="upload"><?php _e('upload', TP_TD); ?></button></li>
	    		    <li><button type="button" class="move">&equiv;</button></li>
	    		    <li><button type="button" class="delete">&#10006;</button></li>
				<?php do_tp_action("tp_admin_editor_video_choice_buttons", $choice, $index); ?>
	    		</ul>
	    	    </div>
		    <?php elseif ( $choice->type == 'html' ): ?>
	    	    <div class="choice choice-html">
	    		<input type="hidden" name="tp_options[choices][<?php echo $index; ?>][type]" value="html">
			<label class="horizontal-label votes-label"><?php _e('Votes', TP_TD); ?>:</label>
	    		<input type="text" placeholder="<?php _e('Votes', TP_TD); ?>" name="tp_options[choices][<?php echo $index; ?>][votes]" value="<?php echo esc_attr($choice->votes) ?>" class="votes-counter widefat">
			<label class="horizontal-label"><?php _e('Code', TP_TD); ?>:</label>
	    		<textarea rows="4" placeholder="<?php _e('HTML Code', TP_TD); ?>" name="tp_options[choices][<?php echo $index; ?>][html]"><?php echo esc_textarea($choice->html) ?></textarea>
			    <?php do_tp_action("tp_admin_editor_html_choice_fields", $choice, $index); ?>
	    		<input type="hidden" name="tp_options[choices][<?php echo $index; ?>][last_index]" value="<?php echo $index; ?>">
	    		<ul class="choice-controllers">
	    		    <li><button type="button" class="move">&equiv;</button></li>
	    		    <li><button type="button" class="delete">&#10006;</button></li>
