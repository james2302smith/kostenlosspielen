...
<p data-toggle="pagination" class="<?php echo isset($options->misc->pagination) ? '' : 'hide'; ?>">
    <label>
        <span><?php _e('Choices per page', 'tp-pager-addon'); ?></span>
        <input type="text" name="tp_options[misc][per_page]" value="<?php echo isset($options->misc->per_page) ? $options->misc->per_page : 5; ?>">
    </label>
</p>
<p data-toggle="pagination" class="<?php echo isset($options->misc->pagination) ? '' : 'hide'; ?>">
    <label>
