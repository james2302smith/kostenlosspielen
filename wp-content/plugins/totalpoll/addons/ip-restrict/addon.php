...
Class TP_IP_Restrict_Addon {
    ...
    {
	// Textdomain
	load_plugin_textdomain('tp-ipr-addon', false, TP_ADDONS_PATH . DS . dirname(__FILE__) . '/languages/');
	// Menu
	...
	$message = sprintf('<p class="warning">%s</p>', __("This poll isn't available in your region.", 'tp-ipr-addon'));
