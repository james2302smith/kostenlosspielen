...
<p data-toggle="only-logged-users" class="<?php echo isset($options->limitations->logged_users_only_vote) ? '' : 'hide'; ?>"><?php _e('With these roles', 'tp-ul-addon'); ?></p>

<p data-toggle="only-logged-users" class="<?php echo isset($options->limitations->logged_users_only_vote) ? '' : 'hide'; ?>">
    <?php
