...
Class TP_Users_Limitations_Addon {
    ...
    {
	// Text domain
	load_plugin_textdomain('tp-ul-addon', false, TP_ADDONS_PATH . DS . dirname(__FILE__) . '/languages/');
	// Settings
	...
	$message = sprintf('<p class="warning">%s</p>', __("You've to be logged in to vote.", 'tp-ul-addon'));
