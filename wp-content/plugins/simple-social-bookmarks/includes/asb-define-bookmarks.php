...
function asb_setup_social_sites() {
    ...
    */
    ...
    array( 'AddThis', 'addthis', '', '', '', 'http://addthis.com/bookmark.php?url=[url]&amp;title=[title]' ),
    ...
    array( '#Google+', 'googleplus', 'google_plusone_share', '', 'google_plus', '' ),
    ...
    array( 'So.cl', 'socl', '', '', '', 'http://www.so.cl/#/search?v=results&bk=1.0&q=[url]' ),
