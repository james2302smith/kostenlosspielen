...
<div id="content" class="fullspan">
    <div style="border:1px solid #CDEAFF; width=100%;padding:1px;margin-bottom:10px;">
        <div class="ads_text">Werbung</div>
        <div class="google_ads_728" style="text-align:center;padding-top:10px;padding-bottom:20px;">
...
while (have_posts()) : the_post(); ?>
    ...
    <div class="large-screenshot">
        ...
        <div class="large-screenimg">
            ...
            $height=530;
            $flashBackground = '';
            if(is_single('tiles-of-the-unexpected')) {
                $flashBackground = 'background-color: #000000;';
            }
            if(strlen($flash)>0) {
                if($flash_width>0){
                    $width=$flash_width;
            ...
            ?>
            <div id="divGamePad" style="width: 100%; height: 100%;text-align:left; position: relative; width: 735px; height: <?php echo $height ?>px">
                <?php
                if(strlen($flash)>0){
                    ?>
                    <object style="<?php echo $flashBackground ?> position: absolute; top: 0px; left: 5;" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="<?php echo $width; ?>" height="<?php echo $height; ?>" id="movie_name" align="middle">
